...
UIOnClickEvent=require"Framework.UI.Component.UIonClickEvent"
...
MsgDataNames= require "Net.MsgHandler.AutoGen.MsgDataNames"
...
MsgHandler:GetInstance()
MsgEventHandler:GetInstance()
