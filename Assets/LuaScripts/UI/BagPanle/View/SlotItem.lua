...
--]]
local SlotItem = BaseClass("SlotItem", UIWrapComponent)
...
local function OnCreate(self)
    ...
    self.bagItem = self:AddComponent(require("UI.BagPanle.View.bagItem"), "pubitem");
...
local function OnRefresh(self, real_index, check)
    ...
    if self.entity==nil then
        self.entity=ItemEntity.New(self.cfgdata);
    else
        self.entity:Refresh(self.cfgdata);
    end
    self.bagItem:SetData(self.entity);

end



SlotItem.OnCreate = OnCreate
SlotItem.OnRefresh = OnRefresh
SlotItem.OnClick = OnClick
