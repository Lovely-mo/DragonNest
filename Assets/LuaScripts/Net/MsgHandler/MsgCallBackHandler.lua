...
local function Handle_QueryGateArg(msg)
    ...
    print("获取服务器列表")
    print(table.dump(msg.RecommandGate))
    ClientData:GetInstance():SetAllServerInfo(msg.allservers)
...
local function Handle_LoginRes(msg)
   ...
   SceneManager:GetInstance():SwitchScene(SceneConfig.SelectRoleScence)
