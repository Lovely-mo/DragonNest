...
local xml = require("Common.Tools.LuaSimpleXMLParser.xmlSimple").newParser()
...
-- node functions test
local node = require("Common.Tools.LuaSimpleXMLParser.xmlSimple").newNode("testName")
...
local childNode = require("Common.Tools.LuaSimpleXMLParser.xmlSimple").newNode("parent")
